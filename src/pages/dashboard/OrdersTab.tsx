...
export default function OrdersTab({
  ...
  const columns: ColumnsType<Order> = [
    ...
    },
    {
      ...
      width: 100,
      sorter: true,
      sortOrder: sortKey === 'user_id' ? (sortDirection === 'asc' ? 'ascend' : 'descend') : null,
      children: [
        {
          title: renderSearchInput('user_id', '会员ID'),
          dataIndex: 'user_id',
          key: 'user_id_child',
          width: 100,
        },
    ...
    },
    {
      ...
      width: 160,
      sorter: true,
      sortOrder: sortKey === 'total_amount' ? (sortDirection === 'asc' ? 'ascend' : 'descend') : null,
      children: [
        {
          title: renderSearchInput('total_amount', '金额'),
          key: 'total_amount_child',
          width: 160,
          render: (_, record) => `${Number(record.total_amount || 0).toFixed(2)} ${record.currency}`,
        },
      ],
    },
    {
      ...
      <div ref={tableHostRef} style={{ flex: 1, minHeight: 0, overflow: 'hidden' }}>
        <Table<Order>
          ...
          onChange={(_, __, sorter) => {
            ...
            const field = (sorter.field || sorter.columnKey) as OrderSortKey | undefined;
