...
const dictionaries: Record<LangCode, Dictionary> = {
  'zh-CN': {
    ...
    'menu.identityDocuments': '证件管理',
    'menu.orders': '订单管理',
    'menu.purchaseOrders': '代购订单',
    'menu.routeTransport': '航线运输管理',
    'menu.sms': '简讯资讯',
    'menu.parcels': '包裹管理',
    'menu.logistics': '物流商管理',
    'menu.storageBins': '库位管理',
    'menu.numberLibrary': '单号库',
    'menu.mall': '商场系统',
    'menu.admins': '系统管理员',
    'menu.system': '系统设置',
  ...
  'zh-TW': {
    ...
    'menu.users': '會員管理',
    'menu.addressBook': '地址簿',
    'menu.identityDocuments': '證件管理',
    'menu.logistics': '物流商管理',
    'menu.storageBins': '庫位管理',
    'menu.numberLibrary': '單號庫',
    'menu.mall': '商場系統',
    'menu.orders': '訂單管理',
    'menu.purchaseOrders': '代購訂單',
    'menu.routeTransport': '航線運輸管理',
    'menu.sms': '簡訊資訊',
    'menu.parcels': '包裹管理',
    'menu.admins': '系統管理員',
    'menu.system': '系統設定',
  ...
  'en-US': {
    ...
    'menu.identityDocuments': 'Identity Documents',
    'menu.logistics': 'Logistics Providers',
    'menu.storageBins': 'Storage Bins',
    'menu.numberLibrary': 'Number Library',
    'menu.mall': 'Mall System',
    'menu.orders': 'Orders',
    'menu.purchaseOrders': 'Purchase Orders',
    'menu.routeTransport': 'Route Transport',
    'menu.sms': 'SMS',
  ...
  'id-ID': {
    ...
    'menu.overview': 'Utama',
    'menu.users': 'Pengguna',
    'menu.addressBook': 'Buku Alamat',
    'menu.identityDocuments': 'Dokumen Identitas',
    'menu.logistics': 'Penyedia Logistik',
    'menu.storageBins': 'Lokasi Gudang',
    'menu.numberLibrary': 'Pustaka Nomor',
    'menu.mall': 'Sistem Pusat Belanja',
    'menu.orders': 'Pesanan',
    'menu.purchaseOrders': 'Pesanan Pembelian',
    'menu.routeTransport': 'Manajemen Rute Transportasi',
    'menu.sms': 'SMS',
